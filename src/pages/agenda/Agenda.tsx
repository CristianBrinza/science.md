        ...
        <div className={styles.agenda}>
            ...
            <span>
              ...
              <span>
                ...
                ROȘCA Valentin, <i>Șef Direcție politici în sectorul zootehnic,</i> <br />
                <i>Ministerul Agriculturii și Industriei Alimentare</i>
                    ...
                    <div className={styles.agenda_block}>
                        ...
                        <div className={styles.agenda_text}>
              <span>
                <b>Rolul asocierii apicultorilor în dezvoltarea bazei melifere</b> <br />
              ...
              <span>
                <b>
                  Substanțe nutritive necesare pentru sporirea vitalității și productivității
                  albinelor
                </b>
                <br />
              ...
              <span>
                ...
                DRAGOMAN Iurii, <i>doctorand, FȘASM, UTM</i>
                    ...
                    <div className={styles.agenda_block}>
                        ...
                        <div className={styles.agenda_text}>
              <span>
                <b>Specii de plante melifere cu utilități aromatice și medicinale</b> <br />
                MELNIC Victor, <i>dr., conf. univ., USM, președinte AO „AROMEDA”</i>
              </span>
                        </div>
                    </div>
                    ...
                    <div className={styles.agenda_block}>
                        ...
                        <div className={styles.agenda_text}>
              <span>
                <b>Plantări forestiere cu valoare adăugată sporită. Conveierul melifer.</b> <br />
                SAINSUS Alexandru V., <i> platforma ARBORETUM.LIVE</i>
                    ...
                    <div className={styles.agenda_block}>
                        ...
                        <div className={styles.agenda_text}>
              <span>
                <b> Aspecte ale calității mierii în dependență de zona geografică a RM</b> <br />
                CATARAGA Ivan, <i>doctor în științe agricole, apicultor</i>
                    ...
                    <div className={styles.agenda_block}>
                        ...
                        <div className={styles.agenda_text}>
              <span>
                <b>Valorificarea eficientă a bazei melifere existente</b> <br />
                SACARA Petru, <i>președinte AO „MOLDAPIS”, apicultor, crescător de mătci</i>
              </span>
                        </div>
                    </div>
                    ...
                    <div className={styles.agenda_block}>
                        ...
                        <div className={styles.agenda_text}>
                            <div>
                                <b> Influența bazei melifere asupra competitivității produselor apicole</b> <br />
