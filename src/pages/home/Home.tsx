    ...
    return (
        <>
            ...
            <div className={styles.home}>
                <div className={styles.home_inside}>
                    <div className={styles.home_inside_left}>
                        <div className={styles.home_inside_left_pretitle}>Seminar științifico-practic</div>
                        <div className={styles.home_inside_left_title}>Potențialul melifer al republicii moldova: știință și practică în apicultură</div>
                        <div className={styles.home_inside_left_subtitle}>
                            Evenimentul este organizat în cadrul proiectului de doctorat „Aspecte tehnologice de întocmire a conveierului melifer în condițiile Republicii Moldova”, specialitatea 421.02 Alimentația animalelor și tehnologia furajelor.
                        </div>
                    ...
                    <img className={styles.home_hero_img} alt="Home" src="/images/home_hero_1.webp" />
                </div>
            </div>
            ...
            <Slider {...settings} className={styles.partners}>
                <div className={styles.partners_block}>
                    <img
                        className={styles.partners_img} alt="Partner" src="/images/p1.webp"/>
                </div>
                <div className={styles.partners_block}>
                    <img
                        className={styles.partners_img} alt="Partner" src="/images/p2.webp"/>
                </div>
                <div className={styles.partners_block}>
                    <img
                        className={styles.partners_img} alt="Partner" src="/images/p3.webp"/>
                </div>
                <div className={styles.partners_block}>
                    <img
                        className={styles.partners_img} alt="Partner" src="/images/p4.webp"/>
                </div>
            </Slider>
            ...
            <div className={styles.home_block_2}>
                ...
                <div className={styles.home_block_2_text_1}>
                    Seminar științifico-practic realizat in cadrul Universitatii tehnică a Moldovei, Facultatea științe agricole silvice și ale mediului, Departamentul resurse animaliere și siguranța alimentelor
                    <br /> <br />
                    Evenimentul este organizat în cadrul proiectului de doctorat <b>„Aspecte tehnologice de întocmire a conveierului melifer în condițiile Republicii Moldova”</b>, specialitatea 421.02 Alimentația
      ...
      <span>
        ...
        <b>MARDARI Tatiana</b>, dr., conf. univ., UTM, FȘASM
                        ...
                        <span>
        <b>MELNIC Victor</b>, dr., conf. univ., USM, președinte AO „AROMEDA”
      </span>
                        <span>
        <b>CIBOTARU Elena</b>, dr., conf. univ., UTM, FȘASM
      </span>
